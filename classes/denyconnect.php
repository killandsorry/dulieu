...
class denyconnect{
	...
	*/
	function denyconnect($total_connect=0){
		...
		$deny_ip_long		= @ip2long($this->deny_ip);
		...
		*/
		...
		if ($check_ip == 1){
			...
			$db_insert = new db_execute("INSERT INTO " . $table_ip_denyconnect . " VALUES(" . $deny_ip_long . "," . $today[0] . ")");
			
			//Kiểm tra total_count nếu >= ngưỡng cho phép thì deny luôn
			if ($total_count >= $this->total_connect){
				//Đưa ra thông báo lỗi
				echo "Xin ch&#224;o, hi&#7879;n t&#7841;i b&#7841;n &#273;ang truy c&#7853;p Website vatgia.com v&#7899;i t&#7889;c &#273;&#7897; qu&#225; nhanh :). <br>";
